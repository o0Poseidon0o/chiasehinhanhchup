...
export const Navbar = () => {
  ...
  return (
    <header className="border-b border-[#221f1c] bg-[#0c0b0a]/80 backdrop-blur-md sticky top-0 z-30 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2">
        <Link to="/" className="flex items-center space-x-2.5 group shrink-0">
          ...
          <div>
            <span className="font-bold text-base sm:text-lg text-gold-100 tracking-tight block leading-tight">
        ...
        <div className="flex items-center space-x-2 sm:space-x-2.5">
          ...
          {!isHome && (
            <Link 
              to="/" 
              className="flex items-center space-x-1.5 bg-gradient-to-r from-gold-600 to-gold-500 hover:from-gold-500 hover:to-gold-400 text-gold-950 px-3 sm:px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all duration-200 shadow-md shadow-gold-500/10"
            >
