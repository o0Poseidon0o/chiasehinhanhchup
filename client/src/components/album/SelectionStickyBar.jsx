...
export const SelectionStickyBar = ({
  ...
  const isLimitReached = maxSelect > 0 && selectedCount >= maxSelect;
      ...
      <div className="max-w-7xl w-full mx-auto flex flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <p className="text-xs sm:text-sm font-bold text-gold-100 flex items-center space-x-1.5">
              <span>Đã chọn:</span>
              <span className="text-gold-400 text-base">{selectedCount}</span>
              {maxSelect > 0 && (
            ...
            <p className="text-[10px] text-[#8e8576]">
              {isClosed
                ...
                ? isLimitReached
                  ...
                  : `Bạn có thể chọn thêm ${maxSelect - selectedCount} ảnh nữa.`
        ...
        {!isClosed ? (
          ...
          >
            ...
            <span>GỬI LỰA CHỌN ({selectedCount})</span>
          </button>
        ) : (
